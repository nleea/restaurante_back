...
Branch-scoped stock tracking with an auditable movement ledger: view stock and
reorder thresholds, register stock in/out movements and physical recounts, and
review movement history. Stock changes are recorded as movements and applied
atomically. Fully tenant-isolated and RBAC-protected.
