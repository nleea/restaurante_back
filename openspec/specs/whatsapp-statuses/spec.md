...
Los estados de WhatsApp programados de una sucursal: la composición de la tarjeta (texto con color
de fondo y tipografía, o imagen con pie), los slots del horario en hora local, la construcción de la
audiencia con sus cuatro exclusiones contadas, la publicación en segundo plano y el registro de lo
que se intentó.

Capability propia y **no** parte de `whatsapp-messaging`, con la que comparte el gateway y los
contactos y nada más: un estado no aterriza en ninguna conversación, no espera respuesta y no saca
ningún hilo de la bandeja. Es lo único que este canal emite sin que nadie escriba primero, y por eso
trae tope de destinatarios, ventana de inactividad y opt-out desde el primer día — el volumen de
salida no solicitado es lo que hace que WhatsApp mire un número.

Nunca se afirma cuánta gente vio un estado: el proveedor no lo reporta y un lote fallido se reporta
como éxito, así que lo más fuerte que se puede decir es que el puente aceptó la publicación.
