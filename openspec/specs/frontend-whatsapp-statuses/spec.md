# frontend-whatsapp-statuses

## Purpose

La pantalla de estados de WhatsApp de la sucursal activa: composición de la tarjeta con vista previa
fiel, editor de horario sobre la semana, la cuenta de la audiencia con sus cuatro exclusiones
desglosadas, y el historial de publicaciones.

Dos cosas son el trabajo de esta pantalla y no adornos. La **vista previa no puede aproximar**: color
de fondo y tipografía son exactamente los dos parámetros que exige el proveedor, así que una vista
previa que los pinte distinto miente sobre lo único que podría salir mal. Y la audiencia **se muestra
desglosada, nunca sólo el número final**: un 200 sin sus exclusiones se lee como cobertura completa
de los contactos del negocio, que no lo es.

Nunca se muestra, insinúa ni estima cuánta gente vio un estado.
